...
class Codename_Custom_Fonts {
	...
	static function add_custom_fonts_in_frontend() {
		wp_add_inline_style( 'codename-stylesheet', self::get_custom_fonts_css() );
	}
	...
	static function add_custom_fonts_in_editor() {
		wp_add_inline_style( 'codename-editor-styles', self::get_custom_fonts_css() );
	}
