...
function harrison_customize_register_theme_info_settings( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Harrison_Customize_Links_Control(
			$wp_customize,
			'harrison_theme_options[theme_links]',
			array(
	...
	if ( ! class_exists( 'Harrison_Pro' ) ) {
		$wp_customize->add_control(
			new Harrison_Customize_Upgrade_Control(
				$wp_customize,
				'harrison_theme_options[pro_version]',
				array(
					'section'  => 'harrison_section_theme_info',
					'settings' => array(),
					'priority' => 20,
	...
	if ( ! class_exists( 'ThemeZee_Magazine_Blocks' ) ) {
		$wp_customize->add_control(
			new Harrison_Customize_Plugin_Control(
				$wp_customize,
				'harrison_theme_options[magazine_blocks]',
				array(
