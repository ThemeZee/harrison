...
function harrison_customize_register_post_settings( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Harrison_Customize_Header_Control(
			$wp_customize,
			'harrison_theme_options[post_details]',
			array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[meta_date]',
		array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[meta_author]',
		array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[meta_comments]',
		array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[meta_categories]',
		array(
	...
	$wp_customize->add_control(
		new Harrison_Customize_Header_Control(
			$wp_customize,
			'harrison_theme_options[single_post]',
			array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[meta_tags]',
		array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[post_navigation]',
		array(
	...
	$wp_customize->add_control(
		new Harrison_Customize_Header_Control(
			$wp_customize,
			'harrison_theme_options[featured_images]',
			array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[post_image_archives]',
		array(
	...
	$wp_customize->add_setting(
		'harrison_theme_options[post_image_single]',
		array(
