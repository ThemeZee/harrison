...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Codename_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'codename_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'codename' ),
				'next'     => esc_html__( 'Next Font', 'codename' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'codename' ),
			);

			// Set Fonts.
			$this->fonts = Codename_Custom_Fonts::get_available_fonts();
