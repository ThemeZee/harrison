...
class Codename_Custom_Colors {
	...
	static function add_custom_colors_in_frontend() {
		wp_add_inline_style( 'codename-stylesheet', self::get_custom_colors_css() );
	}
	...
	static function add_custom_colors_in_editor() {
		wp_add_inline_style( 'codename-editor-styles', self::get_custom_colors_css() );
	}
